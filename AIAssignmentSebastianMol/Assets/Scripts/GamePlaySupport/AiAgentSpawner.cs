...
public enum enemyType { COMMANDO, HEALER, ASSASIN};
/// <summary>
...
public class AiAgentSpawner : MonoBehaviour
{
    ...
    public void SetAiAgentName()
    {
        ...
        switch (ThisAiAgentNumber)
        {
            ...
            case AiAgentNumber.TeamMemberThree:
                _aiAgentName += " 3";
                break;
            case AiAgentNumber.TeamMemberFour:
                _aiAgentName += " 4";
                break;
        }
    }
    ...
    protected void SpawnObject()
    {
        ...
        {
            case AiAgentNumber.TeamMemberOne:
                _newAiAgent.GetComponent<AI>().enemyType = enemyType.COMMANDO;
                break;
            case AiAgentNumber.TeamMemberTwo:
                _newAiAgent.GetComponent<AI>().enemyType = enemyType.HEALER;
                break;
            case AiAgentNumber.TeamMemberThree:
                _newAiAgent.GetComponent<AI>().enemyType = enemyType.ASSASIN;
                break;
            case AiAgentNumber.TeamMemberFour:
                _newAiAgent.GetComponent<AI>().enemyType = enemyType.COMMANDO;
                break;
